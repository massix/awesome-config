...
require("vain")
vain.widgets.terminal = "mate-terminal"
...
--beautiful.init("/home/mgengarelli/.config/awesome/themes/wabbit/theme.lua")
beautiful.init("/home/mgengarelli/.config/awesome/extended_default_theme.lua")
...
--
-- Set cascade browse layout for im space
awful.layout.set(vain.layout.cascadebrowse, tags[1][4])

-- Set cascade layout for hacking space
awful.layout.set(lain.layout.uselesstile, tags[1][5])

-- Set useless fair for misc space
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        vain.widgets.systemload({ show_all = true }),
        vain.widgets.memusage({ show_swap = true }),
        vain.widgets.cpuusage(),
        vain.widgets.net({ iface = "eth0" }),
        mytasklist[s],
